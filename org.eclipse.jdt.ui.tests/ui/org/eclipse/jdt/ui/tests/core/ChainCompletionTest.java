...
import org.eclipse.jdt.internal.ui.text.java.ChainCompletionProposal;
...
public class ChainCompletionTest extends TestCase {
	...
	public void testBasic() throws Exception {
		...
		for (ICompletionProposal prop : proposals) {
			if (prop instanceof ChainCompletionProposal) {
				IJavaCompletionProposal jprop= (IJavaCompletionProposal) prop;
			}
		}
	...
	private List<ICompletionProposal> computeCompletionProposals(ICompilationUnit cu, int completionIndex) throws Exception {
		TestChainCompletionProposalComputer comp= new TestChainCompletionProposalComputer();
	...
	private class TestChainCompletionProposalComputer extends ChainCompletionProposalComputer {
		@Override
